...
public class NotificationUtils {
    ...
    private static Notification customNotification(Context context,
        ...
        remoteViewsExpanded.setTextViewText(R.id.widget_city, cityAndCountry);
        remoteViews.setTextViewText(R.id.widget_temperature, temperatureWithUnit);
        remoteViewsExpanded.setTextViewText(R.id.widget_temperature, temperatureWithUnit);
        ...
        if (secondTemperature != null) {
            ...
            remoteViewsExpanded.setViewVisibility(R.id.widget_second_temperature, View.VISIBLE);
            remoteViewsExpanded.setTextViewText(R.id.widget_second_temperature, secondTemperature);
        } else {
            remoteViews.setViewVisibility(R.id.widget_second_temperature, View.GONE);
            remoteViewsExpanded.setViewVisibility(R.id.widget_second_temperature, View.GONE);
        }
        ...
        remoteViewsExpanded.setTextViewText(R.id.widget_description, weatherDescription);

        Utils.setWeatherIcon(remoteViews, context, weatherRecord);
        Utils.setWeatherIcon(remoteViewsExpanded, context, weatherRecord);
        ...
        remoteViewsExpanded.setTextViewText(R.id.widget_last_update, lastUpdate);
