...
class MoreGlanceWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = MoreGlanceWidget()
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (action == Constants.ACTION_APPWIDGET_SETTINGS_OPENED) {
            ...
            MainScope().launch {
                try {
                    val glanceIds = GlanceAppWidgetManager(context).getGlanceIds(MoreGlanceWidget::class.java)
...
class MoreGlanceWidget : GlanceAppWidget() {
