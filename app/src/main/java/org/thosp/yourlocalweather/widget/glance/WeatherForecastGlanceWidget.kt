...
class WeatherForecastGlanceWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = WeatherForecastGlanceWidget()
        ...
        if (action == Constants.ACTION_APPWIDGET_SETTINGS_OPENED) {
            ...
            val popUpIntent = Intent(context, WidgetSettingsDialogue::class.java).apply {
                ...
                putStringArrayListExtra(
                    ...
                    arrayListOf("action_city", "action_forecast")
                )
            }
            ...
            MainScope().launch {
                try {
                    val glanceIds = GlanceAppWidgetManager(context).getGlanceIds(WeatherForecastGlanceWidget::class.java)
...
class WeatherForecastGlanceWidget : GlanceAppWidget() {
