...
class ExtLocationGlanceWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = ExtLocationGlanceWidget()
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (action == Constants.ACTION_APPWIDGET_SETTINGS_OPENED) {
            ...
            MainScope().launch {
                try {
                    val glanceIds = GlanceAppWidgetManager(context).getGlanceIds(ExtLocationGlanceWidget::class.java)
...
class ExtLocationGlanceWidget : GlanceAppWidget() {
