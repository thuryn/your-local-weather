...
class WeatherGraphGlanceWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = WeatherGraphGlanceWidget()
        ...
        if (action == Constants.ACTION_APPWIDGET_SETTINGS_OPENED) {
            ...
            val popUpIntent = Intent(context, WidgetSettingsDialogue::class.java).apply {
                ...
                putStringArrayListExtra(
                    ...
                    arrayListOf("action_city", "action_graph")
                )
            }
            ...
            MainScope().launch {
                try {
                    val glanceIds = GlanceAppWidgetManager(context).getGlanceIds(WeatherGraphGlanceWidget::class.java)
...
class WeatherGraphGlanceWidget : GlanceAppWidget() {
